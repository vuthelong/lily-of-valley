...
namespace LilyOfValley.Units
{
    ...
    public class CharacterModel : IDisposable
    {
        ...
        public int CharacterId => this.Data.CharacterId;
        public string DisplayName => this.Data.DisplayName;

        public int Level { get; private set; }
        public int Experience { get; private set; }
        public int ExperienceToNextLevel => this.Data.GetExperienceToNextLevel(Level);
        public bool IsMaxLevel => Level >= this.Data.MaxLevel;
        ...
        {
            var clamped = this.Data.ClampLevel(level);
            var ratio = MaxHealth > 0f ? HealthPercent : 1f;

            Level = clamped;
            this.Data.ApplyTo(Stats, clamped);
        ...
        public bool AddExperience(int amount)
        {
            ...
            while (!IsMaxLevel)
            {
                var required = this.Data.GetExperienceToNextLevel(Level);
